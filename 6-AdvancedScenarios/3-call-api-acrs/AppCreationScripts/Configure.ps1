...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "msal-react-spa-acrs" `
    ...
    Write-Host "  - Navigate to the Manifest page, find the 'optionalClaims' section and add the 'xms_cc' optional claim for Access Token. See manual setup in README.md for exact value." -ForegroundColor Red 
