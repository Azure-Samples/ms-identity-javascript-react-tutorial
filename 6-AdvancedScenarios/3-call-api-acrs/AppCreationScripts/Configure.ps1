...
Function ConfigureApplications
{
   ...
   $serviceAadApplication = New-MgApplication -DisplayName "msal-node-api-acrs" `
    ...
    Write-Host "Successfully registered and configured that app registration for 'msal-node-api-acrs' at `n $servicePortalUrl" -ForegroundColor Green 
   ...
   $clientAadApplication = New-MgApplication -DisplayName "msal-react-spa-acrs" `
    ...
    #Update-MgApplication -ApplicationId $currentAppObjectId -IdentifierUris @("https://$tenantName/msal-react-spa-acrs")
    ...
    $requiredPermission = GetRequiredPermissions -applicationDisplayName "msal-node-api-acrs"`
    ...
    # print the registered app portal URL for any further navigation
    Write-Host "Successfully registered and configured that app registration for 'msal-react-spa-acrs' at `n $clientPortalUrl" -ForegroundColor Green 
