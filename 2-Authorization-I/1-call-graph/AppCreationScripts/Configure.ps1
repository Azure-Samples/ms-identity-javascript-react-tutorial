...
Function ConfigureApplications
{
   ...
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-react-c2s1" `
    ...
    #Update-MgApplication -ApplicationId $currentAppObjectId -IdentifierUris @("https://$tenantName/ms-identity-react-c2s1")
    ...
    Write-Host "Successfully registered and configured that app registration for 'ms-identity-react-c2s1' at `n $spaPortalUrl" -ForegroundColor Green 
    ...
    Write-Host "- App spa  - created at $spaPortalUrl"
