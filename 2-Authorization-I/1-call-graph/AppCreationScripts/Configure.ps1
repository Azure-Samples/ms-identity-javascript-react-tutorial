...
Function ConfigureApplications
{
   ...
   $spaAadApplication = New-MgApplication -DisplayName "ms-identity-react-c2s1" `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ms-identity-react-c2s1")
    ...
    $dictionary = @{ "Enter_the_Application_Id_Here" = $spaAadApplication.AppId;"Enter_the_Tenant_Info_Here" = $tenantId;"Enter_the_Redirect_Uri" = $spaAadApplication.Spa.RedirectUris[1];"Enter_the_Post_Redirect_Uri" = $spaAadApplication.Spa.RedirectUris[0] };
